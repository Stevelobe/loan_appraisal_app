  ...
  return (
    <div className="space-y-6 pt-6 border-t border-slate-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Field 1: Legal Mortgage Agreement Document (File Upload) */}
        <FormField 
          name="legal_mortgage_agreement_document" 
          label="Legal Mortgage Agreement Document" 
          type="file" 
          helpText="Upload the signed legal agreement document."
        />

        {/* Field 2: Supporting Documents (Textarea for notes/list) */}
        <div className="md:col-span-2">
            <FormField 
              name="supporting_documents_notes" 
      ...
      <div className="pt-4 space-y-3">
        ...
        <FormField 
            name="land_title_document_check" 
        ...
        <FormField 
            name="power_of_attorney_document_check" 
