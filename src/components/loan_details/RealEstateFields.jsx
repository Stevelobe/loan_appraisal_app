      ...
      <div className="pt-4 space-y-4 border-t border-slate-200">
        <h4 className="text-xl font-semibold text-slate-700 pb-2">Internal Confirmation Checks</h4>
         <FormField 
          ...
          type="checkbox" 
          helpText="Is the signed agreement documenting the mortgage valid ?"
        />
        {/* Checkbox 1: Loan Duration >= 10 Years */}
        <FormField 
            name="loan_duration_ge_10_years" 
        ...
        <FormField 
            name="loan_amount_le_10_percent_paid_up_capital" 
        ...
        <FormField 
            name="land_title_in_borrowers_name" 
